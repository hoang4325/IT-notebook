...
import com.it_notebook_app.databinding.FragmentTopicDetailBinding;
import com.it_notebook_app.ui.adapter.FormulaListAdapter;
...
public class TopicDetailFragment extends Fragment {
    ...
    private void setupRecycler() {
        ...
        adapter.setOnFormulaActionListener(new FormulaListAdapter.OnFormulaActionListener() {
            @Override
            public void onFormulaClick(com.it_notebook_app.data.model.Formula formula) {
            ...
            @Override
            public void onFavoriteToggle(com.it_notebook_app.data.model.Formula formula) {
